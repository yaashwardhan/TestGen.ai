    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        for (var i = 0; i < questions.length; i++) {
          ...
          html += '<li class="option" style="color: greenyellow;" data-value="' + options[0] + '">' + "<span style='color:dimgrey;'>&#9776;</span>" +'<span class="ans-space">Ans: </span>'+ options[0] + '<span class="extra-space"></span>' + '<span class="remove-option" style="color:#CC5500;">&#8998;</span></li>';
